...
export default function SectionHeading({
    ...
    return (
        <div className={`${alignment} space-y-2 mb-7 ${className}`}>
            {headingElement ? headingElement : <h2 className="text-2xl md:text-3xl font-heading tracking-tight text-textPrimary">
