...
type CreateRoleErrors = Partial<Record<keyof CreateRoleData, string>>;
...
export default function CreateRoleModal({
  ...
  const validateForm = (): boolean => {
    const newErrors: CreateRoleErrors = {};
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      onSuccess(
        `Role "${formData.rolename}" has been created successfully!`
      );
